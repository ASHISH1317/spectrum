...
abstract class $ResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic data, String message, int responseCode});
}
...
class _$_ResponseModel implements _ResponseModel {
  const _$_ResponseModel(
      {required this.data, required this.message, required this.responseCode});
...
// required this.success,
  ...
  @override
  String toString() {
    return 'ResponseModel(data: $data, message: $message, responseCode: $responseCode)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(data), message, responseCode);
...
abstract class _ResponseModel implements ResponseModel {
  const factory _ResponseModel(
      ...
      required final int responseCode}) = _$_ResponseModel;

  factory _ResponseModel.fromJson(Map<String, dynamic> json) =
      _$_ResponseModel.fromJson;

  @override // required this.success,
  dynamic get data;
  @override
  String get message;
  @override
